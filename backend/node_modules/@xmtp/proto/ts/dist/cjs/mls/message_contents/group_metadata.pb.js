...
exports.DmMembers = exports.Inbox = exports.GroupMetadataV1 = exports.conversationTypeToJSON = exports.conversationTypeFromJSON = exports.ConversationType = exports.protobufPackage = void 0;
/* eslint-disable */
const long_1 = __importDefault(require("long"));
const oneshot_pb_1 = require("./oneshot.pb");
...
(function (ConversationType) {
    ...
    ConversationType[ConversationType["CONVERSATION_TYPE_ONESHOT"] = 4] = "CONVERSATION_TYPE_ONESHOT";
...
function conversationTypeFromJSON(object) {
    switch (object) {
        ...
        case 4:
        case "CONVERSATION_TYPE_ONESHOT":
            return ConversationType.CONVERSATION_TYPE_ONESHOT;
        case -1:
        case "UNRECOGNIZED":
        default:
...
function conversationTypeToJSON(object) {
    switch (object) {
        ...
        case ConversationType.CONVERSATION_TYPE_ONESHOT:
            return "CONVERSATION_TYPE_ONESHOT";
...
exports.GroupMetadataV1 = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.dmMembers !== undefined) {
            exports.DmMembers.encode(message.dmMembers, writer.uint32(34).fork()).ldelim();
        }
        if (message.oneshotMessage !== undefined) {
            oneshot_pb_1.OneshotMessage.encode(message.oneshotMessage, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.dmMembers = exports.DmMembers.decode(reader, reader.uint32());
                    break;
                case 5:
                    message.oneshotMessage = oneshot_pb_1.OneshotMessage.decode(reader, reader.uint32());
                    break;
                default:
    ...
    fromJSON(object) {
        return {
            ...
            dmMembers: isSet(object.dmMembers)
                ? exports.DmMembers.fromJSON(object.dmMembers)
                : undefined,
            oneshotMessage: isSet(object.oneshotMessage)
                ? oneshot_pb_1.OneshotMessage.fromJSON(object.oneshotMessage)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.dmMembers !== undefined &&
            (obj.dmMembers = message.dmMembers
                ? exports.DmMembers.toJSON(message.dmMembers)
                : undefined);
        message.oneshotMessage !== undefined &&
            (obj.oneshotMessage = message.oneshotMessage
                ? oneshot_pb_1.OneshotMessage.toJSON(message.oneshotMessage)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.dmMembers =
            object.dmMembers !== undefined && object.dmMembers !== null
                ? exports.DmMembers.fromPartial(object.dmMembers)
                : undefined;
        message.oneshotMessage =
            object.oneshotMessage !== undefined && object.oneshotMessage !== null
                ? oneshot_pb_1.OneshotMessage.fromPartial(object.oneshotMessage)
                : undefined;
        return message;
    },
};
...
exports.DmMembers = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.dmMemberOne !== undefined) {
            exports.Inbox.encode(message.dmMemberOne, writer.uint32(10).fork()).ldelim();
        }
        if (message.dmMemberTwo !== undefined) {
            exports.Inbox.encode(message.dmMemberTwo, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.dmMemberOne = exports.Inbox.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.dmMemberTwo = exports.Inbox.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            dmMemberOne: isSet(object.dmMemberOne)
                ? exports.Inbox.fromJSON(object.dmMemberOne)
                : undefined,
            dmMemberTwo: isSet(object.dmMemberTwo)
                ? exports.Inbox.fromJSON(object.dmMemberTwo)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.dmMemberOne !== undefined &&
            (obj.dmMemberOne = message.dmMemberOne
                ? exports.Inbox.toJSON(message.dmMemberOne)
                : undefined);
        message.dmMemberTwo !== undefined &&
            (obj.dmMemberTwo = message.dmMemberTwo
                ? exports.Inbox.toJSON(message.dmMemberTwo)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.dmMemberOne =
            object.dmMemberOne !== undefined && object.dmMemberOne !== null
                ? exports.Inbox.fromPartial(object.dmMemberOne)
                : undefined;
        message.dmMemberTwo =
            object.dmMemberTwo !== undefined && object.dmMemberTwo !== null
                ? exports.Inbox.fromPartial(object.dmMemberTwo)
                : undefined;
        return message;
    },
};
