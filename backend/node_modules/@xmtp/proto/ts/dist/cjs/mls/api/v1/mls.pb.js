...
const signature_pb_2 = require("../../../identity/associations/signature.pb");
...
function createBaseWelcomeMessage_V1() {
    return {
        ...
        wrapperAlgorithm: 0,
        welcomeMetadata: new Uint8Array(),
    };
}
exports.WelcomeMessage_V1 = {
    ...
    fromJSON(object) {
        return {
            ...
            wrapperAlgorithm: isSet(object.wrapperAlgorithm)
                ? (0, wrapper_encryption_pb_1.welcomeWrapperAlgorithmFromJSON)(object.wrapperAlgorithm)
                : 0,
            welcomeMetadata: isSet(object.welcomeMetadata)
    ...
    toJSON(message) {
        ...
        message.hpkePublicKey !== undefined &&
            (obj.hpkePublicKey = base64FromBytes(message.hpkePublicKey !== undefined
                ...
                : new Uint8Array()));
        message.wrapperAlgorithm !== undefined &&
            (obj.wrapperAlgorithm = (0, wrapper_encryption_pb_1.welcomeWrapperAlgorithmToJSON)(message.wrapperAlgorithm));
        message.welcomeMetadata !== undefined &&
            (obj.welcomeMetadata = base64FromBytes(message.welcomeMetadata !== undefined
    ...
    fromPartial(object) {
        ...
        message.wrapperAlgorithm = (_d = object.wrapperAlgorithm) !== null && _d !== void 0 ? _d : 0;
        message.welcomeMetadata = (_e = object.welcomeMetadata) !== null && _e !== void 0 ? _e : new Uint8Array();
        return message;
    },
};
...
exports.WelcomeMetadata = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (!message.messageCursor.isZero()) {
    ...
    fromJSON(object) {
        return {
            messageCursor: isSet(object.messageCursor)
    ...
    toJSON(message) {
        const obj = {};
        message.messageCursor !== undefined &&
    ...
    fromPartial(object) {
        ...
        message.messageCursor =
            object.messageCursor !== undefined && object.messageCursor !== null
                ? long_1.default.fromValue(object.messageCursor)
                : long_1.default.UZERO;
        return message;
    },
...
function createBaseBatchPublishCommitLogRequest() {
    return { requests: [] };
}
exports.BatchPublishCommitLogRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.requests) {
            exports.PublishCommitLogRequest.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseBatchPublishCommitLogRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.requests.push(exports.PublishCommitLogRequest.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            requests: Array.isArray(object === null || object === void 0 ? void 0 : object.requests)
                ? object.requests.map((e) => exports.PublishCommitLogRequest.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.requests) {
            obj.requests = message.requests.map((e) => e ? exports.PublishCommitLogRequest.toJSON(e) : undefined);
        }
        else {
            obj.requests = [];
        }
    ...
    fromPartial(object) {
        ...
        const message = createBaseBatchPublishCommitLogRequest();
        message.requests =
            ((_a = object.requests) === null || _a === void 0 ? void 0 : _a.map((e) => exports.PublishCommitLogRequest.fromPartial(e))) || [];
        return message;
    },
};
function createBasePublishCommitLogRequest() {
    return {
        groupId: new Uint8Array(),
...
exports.PublishCommitLogRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.groupId.length !== 0) {
            writer.uint32(10).bytes(message.groupId);
        }
        ...
        if (message.signature !== undefined) {
            signature_pb_2.RecoverableEd25519Signature.encode(message.signature, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBasePublishCommitLogRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.signature = signature_pb_2.RecoverableEd25519Signature.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            ...
            signature: isSet(object.signature)
                ? signature_pb_2.RecoverableEd25519Signature.fromJSON(object.signature)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.signature !== undefined &&
            (obj.signature = message.signature
                ? signature_pb_2.RecoverableEd25519Signature.toJSON(message.signature)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.groupId = (_a = object.groupId) !== null && _a !== void 0 ? _a : new Uint8Array();
        message.serializedCommitLogEntry =
            (_b = object.serializedCommitLogEntry) !== null && _b !== void 0 ? _b : new Uint8Array();
        message.signature =
            object.signature !== undefined && object.signature !== null
                ? signature_pb_2.RecoverableEd25519Signature.fromPartial(object.signature)
                : undefined;
        return message;
    },
};
function createBaseQueryCommitLogRequest() {
    return { groupId: new Uint8Array(), pagingInfo: undefined };
}
exports.QueryCommitLogRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.groupId.length !== 0) {
            writer.uint32(10).bytes(message.groupId);
        }
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseQueryCommitLogRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
function createBaseQueryCommitLogResponse() {
    return {
        groupId: new Uint8Array(),
        commitLogEntries: [],
...
exports.QueryCommitLogResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.groupId.length !== 0) {
            writer.uint32(10).bytes(message.groupId);
        }
        for (const v of message.commitLogEntries) {
            commit_log_pb_1.CommitLogEntry.encode(v, writer.uint32(18).fork()).ldelim();
        }
        if (message.pagingInfo !== undefined) {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseQueryCommitLogResponse();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.commitLogEntries.push(commit_log_pb_1.CommitLogEntry.decode(reader, reader.uint32()));
                    break;
                case 3:
                    message.pagingInfo = exports.PagingInfo.decode(reader, reader.uint32());
                    break;
    ...
    fromJSON(object) {
        return {
            groupId: isSet(object.groupId)
                ? bytesFromBase64(object.groupId)
                : new Uint8Array(),
            commitLogEntries: Array.isArray(object === null || object === void 0 ? void 0 : object.commitLogEntries)
                ? object.commitLogEntries.map((e) => commit_log_pb_1.CommitLogEntry.fromJSON(e))
                : [],
            pagingInfo: isSet(object.pagingInfo)
                ? exports.PagingInfo.fromJSON(object.pagingInfo)
                : undefined,
    ...
    toJSON(message) {
        ...
        message.groupId !== undefined &&
            (obj.groupId = base64FromBytes(message.groupId !== undefined ? message.groupId : new Uint8Array()));
        if (message.commitLogEntries) {
            obj.commitLogEntries = message.commitLogEntries.map((e) => e ? commit_log_pb_1.CommitLogEntry.toJSON(e) : undefined);
        }
        else {
            obj.commitLogEntries = [];
        }
        message.pagingInfo !== undefined &&
            (obj.pagingInfo = message.pagingInfo
                ? exports.PagingInfo.toJSON(message.pagingInfo)
    ...
    fromPartial(object) {
        ...
        message.commitLogEntries =
            ((_b = object.commitLogEntries) === null || _b === void 0 ? void 0 : _b.map((e) => commit_log_pb_1.CommitLogEntry.fromPartial(e))) || [];
        message.pagingInfo =
            object.pagingInfo !== undefined && object.pagingInfo !== null
                ? exports.PagingInfo.fromPartial(object.pagingInfo)
                : undefined;
...
function createBaseBatchQueryCommitLogRequest() {
    return { requests: [] };
}
exports.BatchQueryCommitLogRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.requests) {
            exports.QueryCommitLogRequest.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseBatchQueryCommitLogRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.requests.push(exports.QueryCommitLogRequest.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            requests: Array.isArray(object === null || object === void 0 ? void 0 : object.requests)
                ? object.requests.map((e) => exports.QueryCommitLogRequest.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.requests) {
            obj.requests = message.requests.map((e) => e ? exports.QueryCommitLogRequest.toJSON(e) : undefined);
        }
        else {
            obj.requests = [];
        }
    ...
    fromPartial(object) {
        ...
        const message = createBaseBatchQueryCommitLogRequest();
        message.requests =
            ((_a = object.requests) === null || _a === void 0 ? void 0 : _a.map((e) => exports.QueryCommitLogRequest.fromPartial(e))) || [];
        return message;
    },
};
function createBaseBatchQueryCommitLogResponse() {
    return { responses: [] };
}
exports.BatchQueryCommitLogResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.responses) {
            exports.QueryCommitLogResponse.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseBatchQueryCommitLogResponse();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.responses.push(exports.QueryCommitLogResponse.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            responses: Array.isArray(object === null || object === void 0 ? void 0 : object.responses)
                ? object.responses.map((e) => exports.QueryCommitLogResponse.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.responses) {
            obj.responses = message.responses.map((e) => e ? exports.QueryCommitLogResponse.toJSON(e) : undefined);
        }
        else {
            obj.responses = [];
        }
    ...
    fromPartial(object) {
        ...
        const message = createBaseBatchQueryCommitLogResponse();
        message.responses =
            ((_a = object.responses) === null || _a === void 0 ? void 0 : _a.map((e) => exports.QueryCommitLogResponse.fromPartial(e))) || [];
        return message;
    },
};
class MlsApiClientImpl {
    constructor(rpc) {
        ...
        this.BatchPublishCommitLog = this.BatchPublishCommitLog.bind(this);
        this.BatchQueryCommitLog = this.BatchQueryCommitLog.bind(this);
    }
    ...
    BatchPublishCommitLog(request) {
        const data = exports.BatchPublishCommitLogRequest.encode(request).finish();
        const promise = this.rpc.request("xmtp.mls.api.v1.MlsApi", "BatchPublishCommitLog", data);
        return promise.then((data) => empty_pb_1.Empty.decode(new minimal_1.default.Reader(data)));
    }
    BatchQueryCommitLog(request) {
        const data = exports.BatchQueryCommitLogRequest.encode(request).finish();
        const promise = this.rpc.request("xmtp.mls.api.v1.MlsApi", "BatchQueryCommitLog", data);
        return promise.then((data) => exports.BatchQueryCommitLogResponse.decode(new minimal_1.default.Reader(data)));
    }
}
