...
export function commitResultFromJSON(object) {
    switch (object) {
        case 0:
...
export function commitResultToJSON(object) {
    switch (object) {
...
function createBasePlaintextCommitLogEntry() {
    return {
        ...
        commitSequenceId: Long.UZERO,
        lastEpochAuthenticator: new Uint8Array(),
        commitResult: 0,
        appliedEpochNumber: Long.UZERO,
        appliedEpochAuthenticator: new Uint8Array(),
    };
}
export const PlaintextCommitLogEntry = {
    ...
    fromJSON(object) {
        return {
            ...
            commitSequenceId: isSet(object.commitSequenceId)
                ? Long.fromValue(object.commitSequenceId)
                : Long.UZERO,
            ...
            appliedEpochNumber: isSet(object.appliedEpochNumber)
                ? Long.fromValue(object.appliedEpochNumber)
                : Long.UZERO,
    ...
    toJSON(message) {
        ...
        message.commitSequenceId !== undefined &&
            (obj.commitSequenceId = (message.commitSequenceId || Long.UZERO).toString());
        ...
        message.appliedEpochNumber !== undefined &&
            (obj.appliedEpochNumber = (message.appliedEpochNumber || Long.UZERO).toString());
