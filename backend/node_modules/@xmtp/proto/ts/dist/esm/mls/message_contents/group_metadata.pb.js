...
import { OneshotMessage } from "./oneshot.pb";
...
export const GroupMetadataV1 = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.oneshotMessage !== undefined) {
            OneshotMessage.encode(message.oneshotMessage, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    message.oneshotMessage = OneshotMessage.decode(reader, reader.uint32());
                    break;
                default:
    ...
    fromJSON(object) {
        return {
            ...
            oneshotMessage: isSet(object.oneshotMessage)
                ? OneshotMessage.fromJSON(object.oneshotMessage)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.oneshotMessage !== undefined &&
            (obj.oneshotMessage = message.oneshotMessage
                ? OneshotMessage.toJSON(message.oneshotMessage)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.oneshotMessage =
            object.oneshotMessage !== undefined && object.oneshotMessage !== null
                ? OneshotMessage.fromPartial(object.oneshotMessage)
                : undefined;
        return message;
    },
};
